...
def main():
    ...
    letters = [str(i) for i in range(2, 10)] + ["T", "J", "Q", "K", "A"]
    strengths = {letter: strength for strength, letter in enumerate(letters, 2)}
    
    def hand_strength(hand):
        return [type_strength(hand)] + list(map(lambda char: strengths[char], hand))
